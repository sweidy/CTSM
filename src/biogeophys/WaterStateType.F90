...
#include "shr_assert.h"
  ...
  type, public :: waterstate_type
     ...
     real(r8), pointer :: int_snow_col_old           (:) 
     ...
     real(r8), pointer :: h2osno_col_old             (:)
     ...
     real(r8), pointer :: snw_rds_col_old            (:,:) 
     ...
     real(r8), pointer :: rh_af_patch_old            (:) 
     ...
     real(r8), pointer :: frac_h2osfc_col_old        (:) 
...
# endif
  ...
  subroutine InitAllocate(this, bounds)
    ...
    if (masterproc) then
      write(iulog,*) "allocate WaterStateType"
    end if
