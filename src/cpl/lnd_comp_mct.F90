...
!
    ...
    do while(.not. dosend)
       ...
       if(masterproc) then
         print *, 'after clm import tod: ', tod
         print *, 'after clm import: ', atm2lnd_inst%forc_t_not_downscaled_grc(bounds%begg)
       end if
    ...
    if (mod(tod_sync,21600)==10800 .AND. do_restart) then
      if (first_time) then
         ...
         irrigation_inst%n_irrig_steps_left_patch = irrigation_inst%n_irrig_steps_left_patch_old ! formerly private
         irrigation_inst%irrig_rate_patch = irrigation_inst%irrig_rate_patch_old ! formerly private
         irrigation_inst%irrig_rate_demand_patch = irrigation_inst%irrig_rate_demand_patch_old ! formerly private
         ...
         temperature_inst%t_veg24_patch = temperature_inst%t_veg24_patch_old
         temperature_inst%t_veg240_patch = temperature_inst%t_veg240_patch_old
         temperature_inst%t_a10_patch = temperature_inst%t_a10_patch_old
         temperature_inst%t_ref2m_min_patch = temperature_inst%t_ref2m_min_patch_old
         temperature_inst%t_ref2m_min_r_patch = temperature_inst%t_ref2m_min_r_patch_old
         temperature_inst%t_ref2m_min_u_patch = temperature_inst%t_ref2m_min_u_patch_old
         temperature_inst%t_ref2m_max_patch = temperature_inst%t_ref2m_max_patch_old
         temperature_inst%t_ref2m_max_r_patch = temperature_inst%t_ref2m_max_r_patch_old
         temperature_inst%t_ref2m_max_u_patch = temperature_inst%t_ref2m_max_u_patch_old
         temperature_inst%t_ref2m_min_inst_patch = temperature_inst%t_ref2m_min_inst_patch_old
         temperature_inst%t_ref2m_min_inst_r_patch = temperature_inst%t_ref2m_min_inst_r_patch_old
         temperature_inst%t_ref2m_min_inst_u_patch = temperature_inst%t_ref2m_min_inst_u_patch_old
         temperature_inst%t_ref2m_max_inst_patch = temperature_inst%t_ref2m_max_inst_patch_old
         temperature_inst%t_ref2m_max_inst_r_patch = temperature_inst%t_ref2m_max_inst_r_patch_old
         temperature_inst%t_ref2m_max_inst_u_patch = temperature_inst%t_ref2m_max_inst_u_patch_old
         temperature_inst%t_veg10_day_patch = temperature_inst%t_veg10_day_patch_old
         temperature_inst%t_veg_day_patch = temperature_inst%t_veg_day_patch_old
         temperature_inst%t_veg10_night_patch = temperature_inst%t_veg10_night_patch_old
         temperature_inst%t_veg_night_patch = temperature_inst%t_veg_night_patch_old
         temperature_inst%t_a10_patch = temperature_inst%t_a10_patch_old
         canopystate_inst%fsun24_patch = canopystate_inst%fsun24_patch_old
         canopystate_inst%fsun240_patch = canopystate_inst%fsun240_patch_old
         canopystate_inst%elai240_patch = canopystate_inst%elai240_patch_old
         energyflux_inst%btran_min_patch = energyflux_inst%btran_min_patch_old
         energyflux_inst%btran_min_inst_patch = energyflux_inst%btran_min_inst_patch_old
         solarabs_inst%par240d_z_patch = solarabs_inst%par240d_z_patch_old
         solarabs_inst%par24d_z_patch = solarabs_inst%par24d_z_patch_old
         solarabs_inst%par240x_z_patch = solarabs_inst%par240x_z_patch_old
  ...
  if (mod(tod_sync,21600)==0 .and. .not. do_restart) then
   if(masterproc) then
      ...
      print *, 'clm swap old to orig', tod_sync
   end if
   ...
   photosyns_inst%gs_mol_sha_patch_old = photosyns_inst%gs_mol_sha_patch ! formerly private
   photosyns_inst%gs_mol_sun_ln_patch_old = photosyns_inst%gs_mol_sun_ln_patch ! formerly private
   photosyns_inst%gs_mol_sha_ln_patch_old = photosyns_inst%gs_mol_sha_ln_patch ! formerly private
   ...
   irrigation_inst%n_irrig_steps_left_patch_old = irrigation_inst%n_irrig_steps_left_patch
   irrigation_inst%irrig_rate_patch_old = irrigation_inst%irrig_rate_patch
   irrigation_inst%irrig_rate_demand_patch_old = irrigation_inst%irrig_rate_demand_patch
   ...
   temperature_inst%t_veg24_patch_old = temperature_inst%t_veg24_patch
   temperature_inst%t_veg240_patch_old = temperature_inst%t_veg240_patch
   temperature_inst%t_a10_patch_old = temperature_inst%t_a10_patch
   temperature_inst%t_ref2m_min_patch_old = temperature_inst%t_ref2m_min_patch
   temperature_inst%t_ref2m_min_r_patch_old = temperature_inst%t_ref2m_min_r_patch
   temperature_inst%t_ref2m_min_u_patch_old = temperature_inst%t_ref2m_min_u_patch
   temperature_inst%t_ref2m_max_patch_old = temperature_inst%t_ref2m_max_patch
   temperature_inst%t_ref2m_max_r_patch_old = temperature_inst%t_ref2m_max_r_patch
   temperature_inst%t_ref2m_max_u_patch_old = temperature_inst%t_ref2m_max_u_patch
   temperature_inst%t_ref2m_min_inst_patch_old = temperature_inst%t_ref2m_min_inst_patch
   temperature_inst%t_ref2m_min_inst_r_patch_old = temperature_inst%t_ref2m_min_inst_r_patch
   temperature_inst%t_ref2m_min_inst_u_patch_old = temperature_inst%t_ref2m_min_inst_u_patch
   temperature_inst%t_ref2m_max_inst_patch_old = temperature_inst%t_ref2m_max_inst_patch
   temperature_inst%t_ref2m_max_inst_r_patch_old = temperature_inst%t_ref2m_max_inst_r_patch
   temperature_inst%t_ref2m_max_inst_u_patch_old = temperature_inst%t_ref2m_max_inst_u_patch
   temperature_inst%t_veg10_day_patch_old = temperature_inst%t_veg10_day_patch
   temperature_inst%t_veg_day_patch_old = temperature_inst%t_veg_day_patch
   temperature_inst%t_veg10_night_patch_old = temperature_inst%t_veg10_night_patch
   temperature_inst%t_veg_night_patch_old = temperature_inst%t_veg_night_patch
   temperature_inst%t_a10_patch_old = temperature_inst%t_a10_patch
   canopystate_inst%fsun24_patch_old = canopystate_inst%fsun24_patch
   canopystate_inst%fsun240_patch_old = canopystate_inst%fsun240_patch
   canopystate_inst%elai240_patch_old = canopystate_inst%elai240_patch
   energyflux_inst%btran_min_patch_old = energyflux_inst%btran_min_patch
   energyflux_inst%btran_min_inst_patch_old = energyflux_inst%btran_min_inst_patch
   solarabs_inst%par240d_z_patch_old = solarabs_inst%par240d_z_patch
   solarabs_inst%par24d_z_patch_old = solarabs_inst%par24d_z_patch
   solarabs_inst%par240x_z_patch_old = solarabs_inst%par240x_z_patch
   solarabs_inst%par24x_z_patch_old = solarabs_inst%par24x_z_patch
